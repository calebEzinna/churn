...
# Page 2: Predictive Model
    ...
    model = joblib.load("GradientBoostingClassifier_best_model.joblib")
    ...
    usage_frequency = st.number_input("Enter Usage Frequency")
    support_calls = st.number_input("Enter Number of Support Calls")
    payment_delay = st.number_input("Enter Payment Delay (in days)")
    total_spend = st.number_input("Enter Total Spend")
    last_interaction = st.number_input("Enter Last Interaction (in days)")
